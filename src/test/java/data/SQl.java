...
import databaseentities.CreditEntity;
...
public class SQl {
    ...
    public static void checkPaymentStatus(Status status) throws SQLException {
        ...
        val payment = runner.query(conn, paymentDataSQL, new BeanHandler<>(PaymentEntity.class));
    ...
    public static void checkCreditStatus(Status status) throws SQLException {
        ...
        val credit = runner.query(conn, creditDataSQL, new BeanHandler<>(CreditEntity.class));
